## mbdyn_post_ehd_plot_mesh.tst:01
%!demo
%! try
...
%!
%!   mbdyn_post_ehd_plot_mesh(res.log_dat.bearings(1), res.bearings(1).columns.p_n, numel(res.t));
%!   view(-100, -60);
%!
%!   mbdyn_post_ehd_plot_mesh(res.log_dat.bearings(1), res.bearings(1).columns.rho_n, numel(res.t));
%!   view(-100, -60);
%!
%!   mbdyn_post_ehd_plot_mesh(res.log_dat.bearings(1), res.bearings(1).columns.h_n, numel(res.t));
%!   view(-100, -60);
%!
%!   figure_list();
