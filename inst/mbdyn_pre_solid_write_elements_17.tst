## mbdyn_pre_solid_write_elements.tst:08
%!test
%! try
%! ## TEST 17
...
%!   opt_msh.elem_type = {"quad8", "iso20f", "penta15f", "tria6h"};
...
%!   if (isfield(mesh.elements, "iso20f"))
%!     mesh.materials.iso20f = zeros(rows(mesh.elements.iso20f), 1, "int32");
%!     mesh.materials.iso20f([mesh.groups.iso20f(find([[mesh.groups.iso20f.id] == 1])).elements]) = 1;
%!   endif
