...
%!   opt_msh.elem_type = {"tria6h", "tet10hf"};
...
%!   if (isfield(mesh.elements, "tet10hf"))
%!     mesh.materials.tet10hf = zeros(rows(mesh.elements.tet10hf), 1, "int32");
%!     mesh.materials.tet10hf([mesh.groups.tet10hf(find([[mesh.groups.tet10hf.id] == 1])).elements]) = 1;
%!   endif
