## mbdyn_pre_solid_write_elements.tst:04
%!test
%! try
%! ## TEST 4
...
%!   opt_msh.elem_type = {"tria10", "tet20"};
...
%!   mesh.elements.rbe2(2) = fem_pre_mesh_rbe3_from_surf(mesh, 2, node_idx_bearing2, {"tria10"});
%!   mesh.elements.rbe2(1) = fem_pre_mesh_rbe3_from_surf(mesh, 1, node_idx_bearing1, {"tria10"});
%!   if (isfield(mesh.elements, "tet20"))
%!     mesh.materials.tet20 = zeros(rows(mesh.elements.tet20), 1, "int32");
%!     mesh.materials.tet20([mesh.groups.tet20(find([[mesh.groups.tet20.id] == 1])).elements]) = 1;
%!   endif
