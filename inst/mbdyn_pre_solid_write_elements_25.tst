## mbdyn_pre_solid_write_elements.tst:02
%!test
%! try
%! ## TEST 2
...
%!   opt_msh.elem_type = {"quad9", "iso27", "penta18", "tria6h"};
...
%!   mesh.elements.rbe2(2) = fem_pre_mesh_rbe3_from_surf(mesh, 2, node_idx_bearing2, {"quad9", "tria6h"});
%!   mesh.elements.rbe2(1) = fem_pre_mesh_rbe3_from_surf(mesh, 1, node_idx_bearing1, {"quad9", "tria6h"});
