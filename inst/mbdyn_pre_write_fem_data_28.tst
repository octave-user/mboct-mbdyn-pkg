## mbdyn_pre_write_fem_data.tst:06
%!test
%! try
%! ## TEST6
...
%!   grp_idx_beam1 = find([[mesh.groups.penta18].id] == 1);
%!   grp_idx_beam2 = find([[mesh.groups.penta18].id] == 2);
%!   grp_idx_clamp = find([[mesh.groups.quad9].id] == 1);
%!   mesh.materials.penta18(mesh.groups.penta18(grp_idx_beam1).elements) = 1;
%!   mesh.materials.penta18(mesh.groups.penta18(grp_idx_beam2).elements) = 2;
