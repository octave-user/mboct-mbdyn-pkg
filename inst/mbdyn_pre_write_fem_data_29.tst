...
%!       switch (options.elem_type)
%!         case "iso27"
%!           opt_mesh.elem_type = {"iso27", "penta18", "quad9", "tria6h"};
%!         case "iso8"
...
%!           mesh.elements.rbe3(1) = fem_pre_mesh_rbe3_from_surf(mesh, 3, cms_opt.nodes.modal.number, "quad9");
%!         case "iso8"
...
%!           mesh.materials.iso27([mesh.groups.iso27(find([mesh.groups.iso27.id] == 2)).elements]) = 2;
%!           mesh.materials.penta18([mesh.groups.penta18(find([mesh.groups.penta18.id] == 1)).elements]) = 1;
%!           mesh.materials.penta18([mesh.groups.penta18(find([mesh.groups.penta18.id] == 2)).elements]) = 2;
%!         case "iso8"
...
%!       figure_list();
%!     endif
%!     tol = 3e-2; ## FIXME: should be 0.5e-2
%!     for i=1:numel(mbdyn_filenames)
%!       if (~enable_filenames(i))
%!         continue;
%!       endif
...
%! param.h1 = 2.5e-3 / SI_unit.meter; ## fine mesh size
